                ...
                <form method="POST" action="{{ route('product.update', $product) }}" id="updateProduct"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="old_price" class="form-control" id="price"
                            ...
                            value="{{ old('old_price') ? old('old_price') : $product->old_price }}" required />
                        @error('old_price')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" name="new_price" class="form-control" id="price"
                            ...
                            value="{{ old('new_price') ? old('new_price') : $product->new_price }}" required />
                        @error('new_price')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                         ...
                         <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <img src="{{ $product->review_1 ?? 'https://placehold.co/200x200' }}" id="review1Preview" class="w-50">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <img src="{{ $product->review_2 ?? 'https://placehold.co/200x200' }}" id="review2Preview" class="w-50">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <img src="{{ $product->review_3 ?? 'https://placehold.co/200x200' }}"  id="review3Preview" class="w-50">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <img src="{{ $product->cartificate_1 ?? 'https://placehold.co/200x200' }}"  id="cartificate1Preview" class="w-50">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <img src="{{ $product->cartificate_2 ?? 'https://placehold.co/200x200' }}"  id="cartificate2Preview" class="w-50">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <img src="{{ $product->cartificate_3 ?? 'https://placehold.co/200x200' }}"  id="cartificate3Preview" class="w-50">
                            </div>
                        </div>
                        {{-- ------------------ Cartificate End ------------- --}}
