    ...
    <div class="col-lg-12">
        <div class="white_card card_height_100 mb_30">
            ...
            <div class="white_card_body">
                <form method="POST" action="{{ route('slider.store') }}" id="createProduct" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="mb-3">
                        <label class="form-label" for="name">Slider Name</label>
                        <input type="text" name="slider_name" class="form-control" id="product_name"
                            placeholder="Enter slider name" value="{{ old('slider_name') ? old('slider_name') : '' }}"
                            required />
                        @error('slider_name')
